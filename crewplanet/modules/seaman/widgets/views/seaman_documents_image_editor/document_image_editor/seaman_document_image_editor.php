...
<div class="column-image step--null-indent js-state-dnd">

    <h3><strong><?= Yii::t('SeamanModule/documents', 'Шаг 3.') ?></strong> <?= Yii::t('SeamanModule/documents', 'Загрузите изображения документа') ?></h3>
...
<div class="column-image step--null-indent js-state-crop">
    <div class="column-image__title js-crop-place-title" style="display: none;"></div>
    <h3 class="popup-title-doc"><strong><?= Yii::t('SeamanModule/documents', 'Шаг 3.') ?></strong> <?= Yii::t('SeamanModule/documents', 'Загрузите изображения документа') ?></h3>
    <div class="column-image__subtitle column-image__subtitle--bg">Use Edit mode to crop or rotate picture.</div>
    ...
    <div class="btn-toolbar crop-place__buttons">
        ...
        <div class="wrap-group-btns clearfix js-wrap-group-btns">
            ...
            <div class="btn-default-group pull-right wrap-group-control">
                ...
                <button class="btn btn-default js-crop-restore">Restore</button>
                <button class="btn btn-default js-crop-cancel">Cancel</button>
            </div>
        </div>
    </div>
</div>
